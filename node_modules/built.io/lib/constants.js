...
module.exports.Upload_CLS           = 'built_io_upload';
module.exports.APP_USER_ROLE_MAPPER  = 'built_io_application_user_role_mapper';

//Upload Contants

module.exports.UPLOAD_KEY_NAME = 'upload[upload]'

module.exports.BASE_64_REGEX   = /^data:([a-zA-Z]*\/[a-zA-Z+.-]*);(charset=[a-zA-Z0-9\-\/\s]*,)?base64,(\S+)/;
/*
All possible mime type
*/
