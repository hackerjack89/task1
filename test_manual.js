...
p4
  ...
  .then(res => {
    ...
    Person.updateWithQuery({ name: "lmn" }, { name: "lol" }).then(res => {
...
setTimeout(() => {
  ...
  Person.upsertAll({ name: "abc" }, { age: 32 })
    .then(res =>
